...
if (isset($_POST['submitTypeAddFee'])) {
	...
	if (isset($_POST['submitAddAddFee'])) {
		...
		$flagSubOK = $sbmt -> execute(array("j", $uid, $_POST['userName1'], $_POST['userName2'], $_POST['sex'], $_POST['grade'], $_POST['schoolZone1'], $_POST['schoolZone2'], $_POST['schoolZone3'], $_POST['receiptNum'], $_POST['billNum'], $time, str_replace(' ', '', $_POST['priceBK']), $_POST['hour1'], str_replace(' ', '', $_POST['price1YDY']), str_replace(' ', '', $_POST['pay1']), $_POST['hour2'], str_replace(' ', '', $_POST['price2YDY']), str_replace(' ', '', $_POST['pay2']), $_POST['hour3'], str_replace(' ', '', $_POST['price3YDY']), str_replace(' ', '', $_POST['pay3']), $_POST['feeSum'], $course1Product, $subFee1Name, $subFee2Name, $subFee3Name, $subFee4Name, $subFee5Name, $course1, $course1SubFee1, $course1SubFee2, $course1SubFee3, $course1SubFee4, $course1SubFee5, $course2Product, $course2, $course2SubFee1, $course2SubFee2, $course2SubFee3, $course2SubFee4, $course2SubFee5, $course3Product, $course3, $course3SubFee1, $course3SubFee2, $course3SubFee3, $course3SubFee4, $course3SubFee5, $course4Product, $course4, $course4SubFee1, $course4SubFee2, $course4SubFee3, $course4SubFee4, $course4SubFee5, $course5Product, $course5, $course5SubFee1, $course5SubFee2, $course5SubFee3, $course5SubFee4, $course5SubFee5, $course6Product, $course6, $course6SubFee1, $course6SubFee2, $course6SubFee3, $course6SubFee4, $course6SubFee5, $course7Product, $course7, $course7SubFee1, $course7SubFee2, $course7SubFee3, $course7SubFee4, $course7SubFee5, $course8Product, $course8, $course8SubFee1, $course8SubFee2, $course8SubFee3, $course8SubFee4, $course8SubFee5, $course9Product, $course9, $course9SubFee1, $course9SubFee2, $course9SubFee3, $course9SubFee4, $course9SubFee5, $course10Product, $course10, $course10SubFee1, $course10SubFee2, $course10SubFee3, $course10SubFee4, $course10SubFee5));
	...
	if (isset($_POST['submitUpdateAddFee'])) {
		...
		$flagSubOK = $sbmt -> execute(array($_POST['receiptNum'], $_POST['billNum'], $time, str_replace(' ', '', $_POST['priceBK']), str_replace(' ', '', $_POST['price1YDY']), str_replace(' ', '', $_POST['pay1']), str_replace(' ', '', $_POST['price2YDY']), str_replace(' ', '', $_POST['pay2']), str_replace(' ', '', $_POST['price3YDY']), str_replace(' ', '', $_POST['pay3']), $_POST['feeSum'], $course1Product, $course1, $course1SubFee1, $course1SubFee2, $course1SubFee3, $course1SubFee4, $course1SubFee5, $course2Product, $course2, $course2SubFee1, $course2SubFee2, $course2SubFee3, $course2SubFee4, $course2SubFee5, $course3Product, $course3, $course3SubFee1, $course3SubFee2, $course3SubFee3, $course3SubFee4, $course3SubFee5, $course4Product, $course4, $course4SubFee1, $course4SubFee2, $course4SubFee3, $course4SubFee4, $course4SubFee5, $course5Product, $course5, $course5SubFee1, $course5SubFee2, $course5SubFee3, $course5SubFee4, $course5SubFee5, $course6Product, $course6, $course6SubFee1, $course6SubFee2, $course6SubFee3, $course6SubFee4, $course6SubFee5, $course7Product, $course7, $course7SubFee1, $course7SubFee2, $course7SubFee3, $course7SubFee4, $course7SubFee5, $course8Product, $course8, $course8SubFee1, $course8SubFee2, $course8SubFee3, $course8SubFee4, $course8SubFee5, $course9Product, $course9, $course9SubFee1, $course9SubFee2, $course9SubFee3, $course9SubFee4, $course9SubFee5, $course10Product, $course10, $course10SubFee1, $course10SubFee2, $course10SubFee3, $course10SubFee4, $course10SubFee5, $uid, $time, $_POST['receiptNum'], $_POST['billNum']));
	...
	if (isset($_POST['submitTypeTrans'])) {
		...
		if (isset($_POST['submitAddTrans'])) {
			...
			$flagFrom = $sbmtFrom -> execute(array("z", $uid, $_POST['userName1'], $_POST['userName2'], $_POST['schoolZone1'], $_POST['schoolZone2'], $_POST['schoolZone3'], $time, $course1ProductFrom, $course1From, $course2ProductFrom, $course2From, $course3ProductFrom, $course3From, $course4ProductFrom, $course4From, $course5ProductFrom, $course5From, $course6ProductFrom, $course6From, $course7ProductFrom, $course7From, $course8ProductFrom, $course8From, $course9ProductFrom, $course9From, $course10ProductFrom, $course10From, $subFee1Name, $subFee2Name, $subFee3Name, $subFee4Name, $subFee5Name));
			...
			$sbmtTo = $pdo -> prepare("insert into addFeeTable (mode,uid, name1,name2, schoolZone1,schoolZone2,schoolZone3,time,course1Product,course1,course2Product,course2, course3Product,course3, course4Product, course4, course5Product,course5,
								course6Product,course6,course7Product,course7,course8Product,course8,course9Product,course9,course10Product,course10,
								subFee1Name,subFee2Name,subFee3Name,subFee4Name,subFee5Name) values( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			$flagTo = $sbmtTo -> execute(array("z", $uid, $_POST['userName1'], $_POST['userName2'], $_POST['schoolZone1'], $_POST['schoolZone2'], $_POST['schoolZone3'], $time, $course1ProductTo, $course1To, $course2ProductTo, $course2To, $course3ProductTo, $course3To, $course4ProductTo, $course4To, $course5ProductTo, $course5To, $course6ProductTo, $course6To, $course7ProductTo, $course7To, $course8ProductTo, $course8To, $course9ProductTo, $course9To, $course10ProductTo, $course10To, $subFee1Name, $subFee2Name, $subFee3Name, $subFee4Name, $subFee5Name));
...
if (isset($_POST['submitTypeRefund'])) {
	...
	if (isset($_POST['submitAddRefund'])) {
		$sbmt = $pdo -> prepare("insert into addFeeTable (mode,uid, name1,name2, schoolZone1,schoolZone2,schoolZone3,time,course1Product,course1,course2Product,course2, course3Product,course3,course4Product, course4,course5Product, course5,
						course6Product, course6,course7Product, course7,course8Product, course8,course9Product, course9,course10Product, course10,
						subFee1Name,subFee2Name,subFee3Name,subFee4Name,subFee5Name) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
		$flag = $sbmt -> execute(array("t", $uid, $_POST['userName1'], $_POST['userName2'], $_POST['schoolZone1'], $_POST['schoolZone2'], $_POST['schoolZone3'], $time, $course1Product, $course1, $course2Product, $course2, $course3Product, $course3, $course4Product, $course4, $course5Product, $course5, $course6Product, $course6, $course7Product, $course7, $course8Product, $course8, $course9Product, $course9, $course10Product, $course10, $subFee1Name, $subFee2Name, $subFee3Name, $subFee4Name, $subFee5Name));
	...
	if (isset($_POST['submitUpdateRefund'])) {
		...
		$flag = $sbmt -> execute(array("t", $uid, $_POST['userName1'], $_POST['userName2'], $_POST['schoolZone1'], $_POST['schoolZone2'], $_POST['schoolZone3'], $time, $course1, $course2, $course3, $course4, $course5, $subFee1Name, $subFee2Name, $subFee3Name, $subFee4Name, $subFee5Name));
