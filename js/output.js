...
function appendRowYDY(obj, index) {
	...
	if (obj.subFeeCourse == 6) {
		course = courseLoad[5];
	}
	if (obj.subFeeCourse == 7) {
		course = courseLoad[6];
	}
	if (obj.subFeeCourse == 8) {
		course = courseLoad[7];
	}
	if (obj.subFeeCourse == 9) {
		course = courseLoad[8];
	}
	if (obj.subFeeCourse == 10) {
		course = courseLoad[9];
	}
	var name2;
	if (obj.name2 == "") {
...
function loadBKMatrix(obj) {
	...
	for (var i = 0; i < obj.length; i++) {
		...
		if (obj[i].subFeeCourse == 6) {
			course = courseLoad[5];
		}
		if (obj[i].subFeeCourse == 7) {
			course = courseLoad[6];
		}
		if (obj[i].subFeeCourse == 8) {
			course = courseLoad[7];
		}
		if (obj[i].subFeeCourse == 9) {
			course = courseLoad[8];
		}
		if (obj[i].subFeeCourse == 10) {
			course = courseLoad[9];
		}
