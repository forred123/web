...
function sqlTest() {
	...
	// 3发出http请求
	var url = "sqlTest.php";
	url = url + "?sqlTest=1" + "&schoolZone=" + encodeURIComponent(schoolZone) + "&grade=" + grade + "&course=" + course + "&product=" + encodeURIComponent(product) + "&sex=" + sex + "&classIDInMLS=" + classInMLS + "&timeStart=" + timeStart + "&timeEnd=" + timeEnd + "&name=" + name;
	//alert(url);
	// 很重要，必须有的
