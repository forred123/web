...
if (isset($_GET['sqlTeacher'])) {
	...
	if($_GET['timeEnd']=="%"){
		...
		if($_GET['grade'] == "初中"){
			...
			$sbmt -> execute(array($_GET['schoolZone'], $_GET['schoolZone'], $_GET['schoolZone'], $_GET['schoolZone'], $_GET['schoolZone'],
								"初一", "初二", "初三",
								$_GET['course'], $_GET['course'], $_GET['course'], $_GET['course'], $_GET['course'],
								$_GET['product'], $_GET['product'], $_GET['product'], $_GET['product'], $_GET['product'],
								$_GET['workCondition'], $_GET['workTime'], $_GET['sex'],$timeStart, $timeEnd));
		...
		$sbmt = $pdo -> prepare("select * from recordTeacherTable where (schoolZone1 like ? or schoolZone2 like ? or schoolZone3 like ? or schoolZone4 like ? or schoolZone5 like ?)
								...
								and workCondition like ? and workTime like ? and sex like ? and inTime >= ? and inTime <= ? order by convert (name using gbk) asc");
		$sbmt -> execute(array($_GET['schoolZone'], $_GET['schoolZone'], $_GET['schoolZone'], $_GET['schoolZone'], $_GET['schoolZone'],
								$_GET['grade'], $_GET['grade'], $_GET['grade'], $_GET['grade'], $_GET['grade'], $_GET['grade'],
								$_GET['course'], $_GET['course'], $_GET['course'], $_GET['course'], $_GET['course'],
								$_GET['product'], $_GET['product'], $_GET['product'], $_GET['product'], $_GET['product'],
								$_GET['workCondition'], $_GET['workTime'], $_GET['sex'],$timeStart, $timeEnd));
		}
